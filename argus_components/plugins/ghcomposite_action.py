...
from argus_components.workflow import GHWorkflowJob
from argus_components.ir import GHNormalTaskGroup
...
class GHCompositeAction(GHAction):
    ...
    def run(self):
        ...
        # convert action_yml to the IR
        # Check if the action_yml has a 'runs' key
